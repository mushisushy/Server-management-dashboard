...
class ReturningTest(fixtures.TablesTest):
    ...
    def test_insert_w_floats(
        ...
        this tests insertmanyvalues as well as decimal / floating point RETURNING types
        """
    ...
    def test_imv_returning_datatypes(
        ...
        These tests are particularly for the asyncpg driver which needs most types to be
        explicitly cast for the new IMV format
        """
        t = Table(
            "d_t",
            metadata,
