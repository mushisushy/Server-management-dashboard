...
class RowFetchTest(fixtures.TablesTest):
    ...
    def test_row_w_scalar_select(self, connection):
        """
        Test that a scalar select as a column is returned as such and that type
        conversion works OK.

        (this is half a SQLAlchemy Core test and half to catch database backends that
        may have unusual behavior with scalar selects.)
        """
...
class PercentSchemaNamesTest(fixtures.TablesTest):
    ...
    This didn't work for PostgreSQL / MySQL drivers for a long time but is now
    supported.
    """
