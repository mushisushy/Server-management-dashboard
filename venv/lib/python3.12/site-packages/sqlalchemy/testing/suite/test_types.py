...
class StringTest(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    def test_concatenate_binary(self, connection):
        """
        Dialects with special string concatenation operators should implement
        visit_concat_op_binary() and visit_concat_op_clauselist() in their compiler.
...
class DateTimeCoercedToDateTimeTest(_DateFixture, fixtures.TablesTest):
    """This particular suite is testing that datetime parameters get coerced to dates,
    which tends to be something DBAPIs do."""
...
class JSONLegacyStringCastIndexTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    """
    Test JSON index access with "cast to string", which we have documented for a long
    time as how to compare JSON values, but is ultimately not reliable in all cases.

    The "as_XYZ()" comparators should be used instead.
    """
