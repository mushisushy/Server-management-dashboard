...
def variation(argname_or_fn, cases=None):
    """
    A helper around testing.combinations that provides a single namespace that can be
    used as a switch.
...
class Config:
    ...
    def register(cls, db, db_opts, options, file_config):
        ...
        If there are no configs set up yet, this config also gets set as the "_current".
        """
        global any_async
