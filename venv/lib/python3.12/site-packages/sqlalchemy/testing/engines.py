...
def mock_engine(dialect_name=None):
    ...
    It should not be used in other cases, as assert_compile() and assert_sql_execution()
    are much better choices with fewer moving parts.
    """
...
class DBAPIProxyCursor:
    ...
    Tests can provide subclasses of this to intercept DBAPI-level cursor operations.
    """
...
class DBAPIProxyConnection:
    ...
    Tests can provide subclasses of this to intercept DBAPI-level connection operations.
    """
