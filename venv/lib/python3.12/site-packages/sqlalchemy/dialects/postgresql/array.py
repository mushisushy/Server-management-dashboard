...
class array(expression.ExpressionClauseList[_T]):
    ...
    def __init__(
        ...
        **kw: typing_Any,
        ...
        :param clauses: iterable, such as a list, containing elements to be rendered in
            the array :param type\_: optional type. If omitted, the type is inferred
...
class ARRAY(sqltypes.ARRAY[_T]):
    ...
    class Comparator(sqltypes.ARRAY.Comparator[_T]):
        ...
        def contains(
            ...
            """
            Boolean expression.  Test if elements are a superset of the elements of the
        ...
        def contained_by(self, other: typing_Any) -> ColumnElement[bool]:
            ...
            Test if elements are a proper subset of the elements of the argument array
            expression.
            """
        ...
        def overlap(self, other: typing_Any) -> ColumnElement[bool]:
            ...
            Test if array has elements in common with an argument array expression.
            """
