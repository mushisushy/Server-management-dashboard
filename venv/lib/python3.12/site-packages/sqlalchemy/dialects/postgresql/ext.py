...
class ExcludeConstraint(ColumnCollectionConstraint):
    ...
    Defines an EXCLUDE constraint as described in the `PostgreSQL documentation`__.
...
def array_agg(*arg, **kw):
    """PostgreSQL-specific form of :class:`_functions.array_agg`, ensures return type is
    :class:`_postgresql.ARRAY` and not the plain :class:`_types.ARRAY`, unless an
    explicit ``type_`` is passed."""
