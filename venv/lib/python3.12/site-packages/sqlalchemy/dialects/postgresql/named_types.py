...
class NamedType(schema.SchemaVisitable, sqltypes.TypeEngine):
    ...
    def _check_for_name_in_memos(self, checkfirst: bool, kw: Dict[str, Any]) -> bool:
        ...
        This to ensure a particular named type is operated upon only once within any
        kind of create/drop sequence without relying upon "checkfirst".
        """
...
class ENUM(NamedType, type_api.NativeForEmulated, sqltypes.Enum):
    ...
    def create(self, bind: _CreateDropBind, checkfirst: bool = True) -> None:
        """
        Emit ``CREATE TYPE`` for this :class:`_postgresql.ENUM`.
    ...
    def get_dbapi_type(self, dbapi: ModuleType) -> None:
        """Dont return dbapi.STRING for ENUM in PostgreSQL, since that's a different
        type."""
