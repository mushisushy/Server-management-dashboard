...
class Range(Generic[_T]):
    ...
    def __eq__(self, other: Any) -> bool:
        """Compare this range to the `other` taking into account bounds inclusivity,
    ...
    def _upper_edge_adjacent_to_lower(
        ...
        """Determine whether an upper bound is immediately successive to a lower
        bound."""
...
class AbstractRange(sqltypes.TypeEngine[_T]):
    ...
    class comparator_factory(TypeEngine.Comparator[Range[Any]]):
        ...
        def contains(self, other: Any, **kw: Any) -> ColumnElement[bool]:
            """
            Boolean expression. Returns true if the right hand operand, which can be an
        ...
        def contained_by(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the column is contained within the right hand operand.
            """
        ...
        def overlaps(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the column overlaps (has points in common with) the right
            hand operand.
            """
        ...
        def strictly_left_of(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the column is strictly left of the right hand operand.
            """
        ...
        def strictly_right_of(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the column is strictly right of the right hand operand.
            """
        ...
        def not_extend_right_of(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the range in the column does not extend right of the range
            in the operand.
            """
        ...
        def not_extend_left_of(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the range in the column does not extend left of the range in
            the operand.
            """
        ...
        def adjacent_to(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns true if the range in the column is adjacent to the range in the
            operand.
            """
        ...
        def union(self, other: Any) -> ColumnElement[bool]:
            ...
            Returns the union of the two ranges. Will raise an exception if the
            resulting range is not contiguous.
            """
        ...
        def intersection(self, other: Any) -> ColumnElement[Range[_T]]:
            ...
            Returns the intersection of the two ranges. Will raise an exception if the
            resulting range is not contiguous.
            """
...
class AbstractSingleRangeImpl(AbstractSingleRange[_T]):
    """Marker for AbstractSingleRange that will apply a subclass-specific adaptation."""
...
class AbstractMultiRangeImpl(AbstractMultiRange[_T]):
    """Marker for AbstractMultiRange that will apply a subclass-specific adaptation."""
