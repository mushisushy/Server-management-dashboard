    ...
    * Path index operations returning text (the ``#>>`` operator)::
    ...
    class Comparator(sqltypes.JSON.Comparator[_T]):
        ...
        def astext(self) -> ColumnElement[str]:
            """
            On an indexed expression, use the "astext" (e.g. "->>") conversion when
            rendered in SQL.
...
class JSONB(JSON):
    ...
    class Comparator(JSON.Comparator[_T]):
        ...
        def has_key(self, other: Any) -> ColumnElement[bool]:
            ...
            Test for presence of a key (equivalent of
        ...
        def contains(self, other: Any, **kwargs: Any) -> ColumnElement[bool]:
            ...
            keys of the argument jsonb expression (equivalent of the ``@>`` operator).
        ...
        def contained_by(self, other: Any) -> ColumnElement[bool]:
            ...
            Test if keys are a proper subset of the
        ...
        def delete_path(
            ...
            """
            JSONB expression. Deletes field or array element specified in the argument
            array (equivalent of the ``#-`` operator).
        ...
        def path_exists(self, other: Any) -> ColumnElement[bool]:
            """
            Boolean expression. Test for presence of item given by the argument JSONPath
            expression (equivalent of the ``@?`` operator).
        ...
        def path_match(self, other: Any) -> ColumnElement[bool]:
            """
            Boolean expression. Test if JSONPath predicate given by the argument
            JSONPath expression matches (equivalent of the ``@@`` operator).
