    ...
    * Concatenation::
    ...
    class Comparator(sqltypes.Indexable.Comparator, sqltypes.Concatenable.Comparator):
        ...
        def has_key(self, other):
            ...
            Test for presence of a key.  Note that the key may be a SQLA expression.
            """
        ...
        def has_all(self, other):
            ...
            Test for presence of all keys in jsonb
            """
        ...
        def has_any(self, other):
            ...
            Test for presence of any key in jsonb
            """
            return self.operate(HAS_ANY, other, result_type=sqltypes.Boolean)

        def contains(self, other, **kwargs):
            """
            Boolean expression.  Test if keys (or array) are a superset of/contained the
        ...
        def contained_by(self, other):
            ...
            Test if keys are a proper subset of the keys of the argument jsonb
            expression.
            """
        ...
        def defined(self, key):
            ...
            Test for presence of a non-NULL value for the key.  Note that the key may be
            a SQLA expression.
            """
        ...
        def delete(self, key):
            ...
            Returns the contents of this hstore with the given key deleted.  Note that
            the key may be a SQLA expression.
            """
        ...
        def slice(self, array):
            ...
            Returns a subset of an hstore defined by array of keys.
            """
        ...
        def array(self):
            ...
            Returns array of alternating keys and values.
            """
...
class hstore(sqlfunc.GenericFunction):
    """
    Construct an hstore value within a SQL expression using the PostgreSQL ``hstore()``
    function.
...
def _parse_hstore(hstore_str):
    ...
    Attempts to approximate PG's hstore input parsing rules as closely as possible.
    Although currently this is not strictly necessary, since the current implementation
    of hstore's output syntax is stricter than what it accepts as input, the
    documentation makes no guarantees that will always be the case.
    """
    result = {}
    pos = 0
