...
class PGCompiler(compiler.SQLCompiler):
    ...
    def delete_extra_from_clause(
        ...
        USING clause specific to PostgreSQL.
        """
        kw["asfrom"] = True
        return "USING " + ", ".join(
            t._compiler_dispatch(self, fromhints=from_hints, **kw) for t in extra_froms
...
class ReflectedDomain(ReflectedNamedType):
    ...
    """The string representation of the default value of this domain or ``None`` if none
    present."""
...
class PGDialect(default.DefaultDialect):
    ...
    def _reflect_type(
        ...
        """
        Attempts to reconstruct a column type defined in ischema_names based on the
        information available in the format_type.
