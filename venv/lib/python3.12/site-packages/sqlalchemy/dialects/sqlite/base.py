...
class _DateTimeMixin:
    ...
    def format_is_text_affinity(self):
        ...
        If the storage format contains no non-numeric characters, it will imply a
        NUMERIC storage format on SQLite; in this case, the type will generate its DDL
        as DATE_CHAR, DATETIME_CHAR, TIME_CHAR.
        """
