...
class _ms_numeric_pyodbc:
    ...
    The routines here are needed for older pyodbc versions as well as current mxODBC
    versions.
    """
...
class _ms_binary_pyodbc:
    ...
    If the value is null, return a pyodbc-specific BinaryNull object to prevent pyODBC
    [and FreeTDS] from defaulting binary NULL types to SQLWCHAR and causing implicit
    conversion errors.
    """
