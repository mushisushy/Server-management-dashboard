...
class NUMERIC(_NumericType, sqltypes.NUMERIC):
    ...
    def __init__(self, precision=None, scale=None, asdecimal=True, **kw):
        ...
        :param precision: Total digits in this number. If scale and precision are both
            None, values are stored to limits allowed by the server.
        :param scale: The number of digits after the decimal point.
        :param unsigned: a boolean, optional.
        :param zerofill: Optional. If true, values will be stored as strings left-padded
            with zeros. Note that this does not effect the values returned by the
...
class BIT(sqltypes.TypeEngine):
    ...
    This type is for MySQL 5.0.3 or greater for MyISAM, and 5.0.5 or greater for MyISAM,
    MEMORY, InnoDB and BDB.  For older versions, use a MSTinyInteger() type.
    """
...
class CHAR(_StringType, sqltypes.CHAR):
    ...
    def __init__(self, length=None, **kwargs):
        ...
        :param binary: Optional, use the default binary collation for the national
            character set. This does not affect the type of data stored, use a BINARY
            type for binary data.
        :param collation: Optional, request a particular collation. Must be compatible
...
class NVARCHAR(_StringType, sqltypes.NVARCHAR):
    ...
    For variable-length character data in the server's configured national character
    set.
    """
