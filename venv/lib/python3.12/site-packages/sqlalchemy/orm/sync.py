...
"""Private module containing functions used for copying data between instances based on
join conditions."""
...
def source_modified(uowcommit, source, source_mapper, synchronize_pairs):
    """Return true if the source object has changes from an old to a new value on the
    given synchronize pairs."""
    for l, r in synchronize_pairs:
        try:
            prop = source_mapper._columntoproperty[l]
        except exc.UnmappedColumnError as err:
