...
def add_class(
    ...
    """Add a class to the _decl_class_registry associated with the given declarative
    class."""
...
def _key_is_empty(
    ...
    "test" is a callable that will be passed an object should return True if the given
    object is the one we were looking for.

    We can't pass the actual object itself b.c. this is for testing garbage collection;
    the caller will have to have removed references to the object itself.
    """
