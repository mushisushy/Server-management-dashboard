...
class scoped_session(Generic[_S]):
    ...
    def __call__(self, **kw: Any) -> _S:
        r"""
        Return the current :class:`.Session`, creating it using the
    ...
    def query_property(
        ...
        """
        Return a class property which produces a legacy :class:`_query.Query` object
    ...
    def bind(self) -> Optional[Union[Engine, Connection]]:
        r"""Proxy for the :attr:`_orm.Session.bind` attribute on behalf of the
        :class:`_orm.scoping.scoped_session` class."""  # noqa: E501
