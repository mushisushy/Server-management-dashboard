...
class ClassManager(
    ...
    def _all_sqla_attributes(self, exclude=None):
        """
        Return an iterator of all classbound attributes that are implement
    ...
    def _subclass_manager(self, cls: Type[_T]) -> ClassManager[_T]:
        ...
        This is called automatically when attributes are instrumented so that the
        attributes can be propagated to subclasses against their own class-local
        manager, without the need for mappers etc. to have already pre-configured
        managers for the full class hierarchy.   Mappers can post-configure the auto-
        generated ClassManager when needed.
        """
    ...
    def state_getter(self):
        ...
        "state getter" callables should raise either KeyError or AttributeError if no
...
def is_instrumented(instance, key):
    """
    Return True if the given attribute on the given instance is instrumented by the
    attributes package.

    This function may be used regardless of instrumentation applied directly to the
    class, i.e. no descriptors are required.
    """
