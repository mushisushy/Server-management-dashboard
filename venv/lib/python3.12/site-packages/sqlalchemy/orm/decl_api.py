...
class DeclarativeAttributeIntercept(
    ...
    """Metaclass that may be used in conjunction with the :class:`_orm.DeclarativeBase`
    class to support addition of class attributes dynamically."""
...
def synonym_for(
    ...
    """
    Decorator that produces an :func:`_orm.synonym` attribute in conjunction with a
    Python descriptor.
...
class declared_attr(interfaces._MappedAttribute[_T], _declared_attr_common):
    """
    Mark a class-level method as representing the definition of a mapped property or
...
class DeclarativeBase(
    ...
    **never accessed by a mapped class without being called explicitly via
    ...
    if typing.TYPE_CHECKING:
        ...
        """Refers to the :class:`_orm.registry` in use where new :class:`_orm.Mapper`
        ...
        """
        The :class:`_orm.Mapper` object to which a particular class is mapped.
        ...
        """
        The :class:`_sql.FromClause` to which a particular subclass is mapped.
        ...
        __tablename__: Any
        """
        String name to assign to the generated :class:`_schema.Table` object, if not
        specified directly via :attr:`_orm.DeclarativeBase.__table__`.
        ...
        __mapper_args__: Any
        """
        Dictionary of arguments which will be passed to the :class:`_orm.Mapper`
        constructor.
        ...
        :ref:`orm_declarative_table_configuration` for background on the specific
...
class DeclarativeBaseNoMeta(
    ...
    """
    Same as :class:`_orm.DeclarativeBase`, but does not use a metaclass to intercept new
    attributes.
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def mapped_as_dataclass(
        ...
        *,
        ...
        class, and additionally convert the class to be a Python dataclass.
    ...
    def as_declarative_base(self, **kw: Any) -> Callable[[Type[_T]], Type[_T]]:
        """
        Class decorator which will invoke :meth:`_orm.registry.generate_base` for a
        given base class.
...
def as_declarative(**kw: Any) -> Callable[[Type[_T]], Type[_T]]:
    """
    Class decorator which will adapt a given class into a :func:`_orm.declarative_base`.
