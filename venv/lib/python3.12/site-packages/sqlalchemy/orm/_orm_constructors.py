...
def contains_alias(alias: Union[Alias, Subquery]) -> AliasOption:
    r"""Return a :class:`.MapperOption` that will indicate to the :class:`_query.Query`
...
def mapped_column(
    ...
    **kw: Any,
    ...
    r"""
    Declare a new ORM-mapped :class:`_schema.Column` construct for use within
    :ref:`Declarative Table <orm_declarative_table>` configuration.
...
def orm_insert_sentinel(
    ...
    *,
    ...
    """
    Provides a surrogate :func:`_orm.mapped_column` that generates a so-called
...
def backref(name: str, **kwargs: Any) -> ORMBackrefArgument:
    """
    When using the :paramref:`_orm.relationship.backref` parameter, provides specific
    parameters to be used when the new :func:`_orm.relationship` is generated.
...
def deferred(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    r"""
    Indicate a column-based mapped attribute that by default will not load unless
    accessed.
...
def aliased(
    ...
    """
    Produce an alias of the given element, usually an :class:`.AliasedClass` instance.
...
def with_polymorphic(
    ...
    """
    Produce an :class:`.AliasedClass` construct which specifies columns for descendant
