...
class TransactionalContext:
    ...
    Performs validation to ensure the subject of the transaction is not used if the
    transaction were ended prematurely.
    """
    ...
    def _rollback_can_be_called(self) -> bool:
        """
        Indicates the object is in a state that is known to be acceptable for rollback()
        to be called.
