...
class ConnectionCharacteristic(abc.ABC):
    """
    An abstract base for an object that can set, get and reset a per-connection
    characteristic, typically one that gets reset when the connection is returned to the
    connection pool.
    ...
    def set_connection_characteristic(
        ...
        """
        Set characteristic on the :class:`_engine.Connection` to a given value.
