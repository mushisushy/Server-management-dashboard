...
class ObjectKind(Flag):
    """
    Enumerator that indicates which kind of object to return when calling the
    ``get_multi`` methods.
...
class ObjectScope(Flag):
    """Enumerator that indicates which scope to use when calling the ``get_multi``
    methods."""
...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def from_engine(cls, bind: Engine) -> Inspector:
        """
        Construct a new dialect-specific Inspector object from the given engine or
        connection.
    ...
    def _inspection_context(self) -> Generator[Inspector, None, None]:
        """Return an :class:`_reflection.Inspector` from this one that will run all
    ...
    def default_schema_name(self) -> Optional[str]:
        """
        Return the default schema name presented by the dialect for the current engine's
        database user.
    ...
    def get_schema_names(self, **kw: Any) -> List[str]:
        ...
        :param \**kw: Additional keyword argument to pass to the dialect  specific
        implementation. See the documentation of the dialect  in use for more
        information.
        """
    ...
    def has_table(
        ...
        r"""
        Return True if the backend has a table, view, or temporary table of the given
        name.
    ...
    def get_sorted_table_and_fkc_names(
        ...
        **kw: Any,
        ...
        r"""
        Return dependency-sorted table and foreign key constraint names in referred to
    ...
    def sort_tables_on_foreign_key_dependency(
        ...
        **kw: Any,
        ...
        r"""
        Return dependency-sorted table and foreign key constraint names referred to
    ...
    def get_temp_table_names(self, **kw: Any) -> List[str]:
        ...
        This method is unsupported by most dialects; currently only Oracle Database,
        PostgreSQL and SQLite implements it.
    ...
    def get_temp_view_names(self, **kw: Any) -> List[str]:
        ...
        This method is unsupported by most dialects; currently only PostgreSQL and
    ...
    def get_table_options(
        ...
        r"""
        Return a dictionary of options specified when the table of the given name was
        created.
    ...
    def reflect_table(
        ...
        """
        Given a :class:`_schema.Table` object, load its internal constructs based on
        introspection.
