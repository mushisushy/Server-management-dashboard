...
"""Supplies the "preloaded" registry to resolve circular module imports at runtime."""
...
class _ModuleRegistry:
    ...
    def preload_module(self, *deps: str) -> Callable[[_FN], _FN]:
        ...
        This method can be used both as a normal function and as a decorator. No change
        is performed to the decorated object.
        """
        self.module_registry.update(deps)
        return lambda fn: fn

    def import_prefix(self, path: str) -> None:
        """Resolve all the modules in the registry that start with the specified
        path."""
