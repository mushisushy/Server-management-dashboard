...
"""Routines to handle adaption of legacy call signatures, generation of deprecation
...
def _legacy_signature(
    ...
    :param argnames: list of strings, which is *all* arguments that the legacy version
        accepted, including arguments that are still there
    :param converter: lambda that will accept tuple of this full arg signature and
        return tuple of new arg signature.
    """
