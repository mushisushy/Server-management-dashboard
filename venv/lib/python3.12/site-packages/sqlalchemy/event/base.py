...
class _UnpickleDispatch:
    """Serializable callable that re-generates an instance of :class:`_Dispatch` given a
    particular :class:`.Events` subclass."""
...
class _HasEventsDispatch(Generic[_ET]):
    ...
    def _create_dispatcher_class(
        ...
        """Create a :class:`._Dispatch` class corresponding to an :class:`.Events`
        class."""
...
class dispatcher(Generic[_ET]):
    """Descriptor used by target classes to deliver the _Dispatch class at the class
    level and produce new _Dispatch instances for target instances."""
