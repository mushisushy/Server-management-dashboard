...
class HybridExtensionType(InspectionAttrExtensionType):
    ...
    """
    Symbol indicating an :class:`InspectionAttr` that's of type :class:`.hybrid_method`.
...
class _HybridClassLevelAccessor(QueryableAttribute[_T]):
    """Describe the object returned by a hybrid_property() when called as a class-level
    descriptor."""
...
class hybrid_method(interfaces.InspectionAttrInfo, Generic[_P, _R]):
    """A decorator which allows definition of a Python object method with both instance-
    level and class-level behavior."""
...
class hybrid_property(interfaces.InspectionAttrInfo, ORMDescriptor[_T]):
    """A decorator which allows definition of a Python descriptor with both instance-
    level and class-level behavior."""
