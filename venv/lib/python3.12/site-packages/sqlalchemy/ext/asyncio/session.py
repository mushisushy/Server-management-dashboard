...
class AsyncSession(ReversibleProxy[Session]):
    ...
    """
    The class or callable that provides the underlying :class:`_orm.Session` instance
    for a particular :class:`_asyncio.AsyncSession`.
    ...
    async def get_one(
        ...
        *,
        ...
        """
        Return an instance based on the given primary key identifier, or raise an
    ...
    async def stream(
        ...
        **kw: Any,
        ...
        """Execute a statement and return a streaming :class:`_asyncio.AsyncResult`
        object."""
    ...
    async def connection(
        ...
        **kw: Any,
        ...
        r"""
        Return a :class:`_asyncio.AsyncConnection` object corresponding to this
    ...
    def begin_nested(self) -> AsyncSessionTransaction:
        """
        Return an :class:`_asyncio.AsyncSessionTransaction` object which will begin a
        "nested" transaction, e.g. SAVEPOINT.
    ...
    def identity_map(self) -> IdentityMap:
        r"""Proxy for the :attr:`_orm.Session.identity_map` attribute on behalf of the
        :class:`_asyncio.AsyncSession` class."""  # noqa: E501
    ...
    def autoflush(self) -> bool:
        r"""Proxy for the :attr:`_orm.Session.autoflush` attribute on behalf of the
        :class:`_asyncio.AsyncSession` class."""  # noqa: E501
...
class async_sessionmaker(Generic[_AS]):
    ...
    def begin(self) -> _AsyncSessionContextManager[_AS]:
        """
        Produce a context manager that both provides a new :class:`_orm.AsyncSession` as
        well as a transaction that commits.
    ...
    def __call__(self, **local_kw: Any) -> _AS:
        """
        Produce a new :class:`.AsyncSession` object using the configuration established
        in this :class:`.async_sessionmaker`.
