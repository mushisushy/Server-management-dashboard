...
class async_scoped_session(Generic[_AS]):
    ...
    """
    The `session_factory` provided to `__init__` is stored in this attribute and may be
    ...
    def __call__(self, **kw: Any) -> _AS:
        r"""
        Return the current :class:`.AsyncSession`, creating it using the
        :attr:`.scoped_session.session_factory` if not present.
    ...
    async def remove(self) -> None:
        ...
        Different from scoped_session's remove method, this method would use await to
    ...
    @property
    def bind(self) -> Any:
        r"""Proxy for the :attr:`_asyncio.AsyncSession.bind` attribute on behalf of the
        :class:`_asyncio.scoping.async_scoped_session` class."""  # noqa: E501
    ...
    def identity_map(self) -> Any:
        r"""
        Proxy for the :attr:`_orm.Session.identity_map` attribute on behalf of the
    ...
    def autoflush(self) -> Any:
        r"""
        Proxy for the :attr:`_orm.Session.autoflush` attribute on behalf of the
        :class:`_asyncio.AsyncSession` class.
