...
class AsyncConnection(
    ...
    async def start(self, is_ctxmanager: bool = False) -> AsyncConnection:  # noqa: U100
        """Start this :class:`_asyncio.AsyncConnection` object's context outside of
        using a Python ``with:`` block."""
    ...
    def info(self) -> _InfoType:
        """
        Return the :attr:`_engine.Connection.info` dictionary of the underlying
        :class:`_engine.Connection`.
    ...
    def get_transaction(self) -> Optional[AsyncTransaction]:
        """
        Return an :class:`.AsyncTransaction` representing the current transaction, if
        any.
    ...
    def get_nested_transaction(self) -> Optional[AsyncTransaction]:
        """
        Return an :class:`.AsyncTransaction` representing the current nested (savepoint)
        transaction, if any.
    ...
    def dialect(self) -> Dialect:
        r"""Proxy for the :attr:`_engine.Connection.dialect` attribute on behalf of the
        :class:`_asyncio.AsyncConnection` class."""  # noqa: E501
...
class AsyncEngine(ProxyComparable[Engine], AsyncConnectable):
    ...
    async def begin(self) -> AsyncIterator[AsyncConnection]:
        ...
        :class:`_asyncio.AsyncConnection` with an :class:`_asyncio.AsyncTransaction`
        established.
    ...
    def execution_options(self, **opt: Any) -> AsyncEngine:
        ...
        :class:`_asyncio.AsyncConnection` objects with the given execution options.
    ...
    @property
    def url(self) -> URL:
        r"""Proxy for the :attr:`_engine.Engine.url` attribute on behalf of the
        :class:`_asyncio.AsyncEngine` class."""  # noqa: E501
    ...
    @property
    def pool(self) -> Pool:
        r"""Proxy for the :attr:`_engine.Engine.pool` attribute on behalf of the
        :class:`_asyncio.AsyncEngine` class."""  # noqa: E501
    ...
    @property
    def dialect(self) -> Dialect:
        r"""Proxy for the :attr:`_engine.Engine.dialect` attribute on behalf of the
        :class:`_asyncio.AsyncEngine` class."""  # noqa: E501
    ...
    def name(self) -> Any:
        r"""
        String name of the :class:`~sqlalchemy.engine.interfaces.Dialect` in use by this
        :class:`Engine`.
    ...
    def driver(self) -> Any:
        r"""
        Driver name of the :class:`~sqlalchemy.engine.interfaces.Dialect` in use by this
        :class:`Engine`.
...
class AsyncTransaction(
    ...
    async def start(self, is_ctxmanager: bool = False) -> AsyncTransaction:
        """Start this :class:`_asyncio.AsyncTransaction` object's context outside of
        using a Python ``with:`` block."""
