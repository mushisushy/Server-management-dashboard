...
def _scan_symbol_table_entry(
    ...
    """Extract mapping information from a SymbolTableNode that's in the type.names
    dictionary."""
...
def _scan_declarative_assignment_stmt(
    ...
    """Extract mapping information from an assignment statement in a declarative
    class."""
...
def _scan_for_mapped_bases(
    ...
    """
    Given a class, iterate through its superclass hierarchy to find all other classes
    that are considered as ORM-significant.

    Locates non-mapped mixins and scans them for mapped attributes to be applied to
    subclasses.
    """
