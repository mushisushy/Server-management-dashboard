...
class ShardedSession(Session):
    ...
    def _identity_lookup(
        ...
        **kw: Any,
        ...
        """
        Override the default :meth:`.Session._identity_lookup` method so that we search
        for a given non-token primary key identity across all possible identity tokens
        (e.g. shard ids).
    ...
    def connection_callable(
        ...
        **kw: Any,
        ...
        """Provide a :class:`_engine.Connection` to use in the unit of work flush
        process."""
...
class set_shard_id(ORMOption):
    """
    A loader option for statements to apply a specific shard id to the primary query as
    well as for additional relationship and column loaders.
