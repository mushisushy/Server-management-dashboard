...
def try_cast(
    ...
    """
    Produce a ``TRY_CAST`` expression for backends which support it; this is a ``CAST``
...
def text(text: str) -> TextClause:
    r"""
    Construct a new :class:`_expression.TextClause` clause, representing a textual SQL
    string directly.
