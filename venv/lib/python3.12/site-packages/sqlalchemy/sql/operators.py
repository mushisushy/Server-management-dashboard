...
class ColumnOperators(Operators):
    ...
    def is_distinct_from(self, other: Any) -> ColumnOperators:
        ...
        Renders "a IS DISTINCT FROM b" on most platforms; on some such as SQLite may
        render "a IS NOT b".
        """
    ...
    def __getitem__(self, index: Any) -> ColumnOperators:
        ...
        This can be used by some database-specific types such as PostgreSQL ARRAY and
        HSTORE.
        """
    ...
    def __lshift__(self, other: Any) -> ColumnOperators:
        ...
        Not used by SQLAlchemy core, this is provided for custom operator systems which
    ...
    def bitwise_xor(self, other: Any) -> ColumnOperators:
        """
        Produce a bitwise XOR operation, typically via the ``^`` operator, or ``#`` for
        PostgreSQL.
    ...
    def collate(self, collation: str) -> ColumnOperators:
        """
        Produce a :func:`_expression.collate` clause against the parent object, given
    ...
    def between(
        ...
        """Produce a :func:`_expression.between` clause against the parent object, given
