"""
Implements a Jinja / Python combination lexer.
...
def count_newlines(value: str) -> int:
    ...
    This is useful for extensions that filter a stream.
    """
...
class TokenStreamIterator:
    ...
    Iterate over the stream until the eof token is reached.
    """
...
class Lexer:
    """
    Class that implements a lexer for a given environment. Automatically created by the
    environment class, usually you don't have to do that.

    Note that the lexer is not automatically bound to an environment. Multiple
    ...
    def _normalize_newlines(self, value: str) -> str:
        """Replace all newlines with the configured sequence in strings and template
        data."""
    ...
    def wrap(
        ...
        """This is called with the stream as returned by `tokenize` and wraps every
        token in a :class:`Token` and converts the value."""
    ...
    def tokeniter(
        ...
        """
        This method tokenizes the text and returns the tokens in a generator. Use this
        method if you just want to tokenize a template.
