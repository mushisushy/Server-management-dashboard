...
class Parser:
    ...
    It's passed to extensions and can be used to parse expressions or statements.
    """
    ...
    def fail(
        ...
        """Convenience method that raises `exc` with the message, passed line number or
        last line number as well as the current name and filename."""
        if lineno is None:
    ...
    def fail_unknown_tag(
        ...
        Tries to fail with a human readable error message that could help to identify
        the problem.
        """
    ...
    def parse_statements(
        ...
        This is used to parse the body of statements as it also
    ...
    def parse_assign_target(
        ...
        As Jinja allows assignments to
    ...
    def parse_expression(self, with_condexpr: bool = True) -> nodes.Expr:
        ...
        Per default all expressions are parsed, if
    ...
    def parse_primary(self, with_namespace: bool = False) -> nodes.Expr:
        ...
        If ``with_namespace`` is enabled, also
    ...
    def parse_tuple(
        ...
        comma a :class:`~jinja2.nodes.Tuple` node is created. This method could also
        return a regular expression instead of a tuple if no commas where found.
