...
class Authorization:
    ...
    def __init__(
        ...
        """
        A dict of parameters parsed from the header.

        Either this or :attr:`token`
    ...
    def from_header(cls, value: str | None) -> te.Self | None:
        """
        Parse an ``Authorization`` header value and return an instance, or ``None`` if
        the value is empty.
...
class WWWAuthenticate:
    ...
    def parameters(self) -> dict[str, str | None]:
        """
        A dict of parameters for the header.

        Only one of this or :attr:`token` should
    ...
    def from_header(cls, value: str | None) -> te.Self | None:
        """
        Parse a ``WWW-Authenticate`` header value and return an instance, or ``None`` if
        the value is empty.
