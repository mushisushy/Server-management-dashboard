...
def csp_property(key: str) -> t.Any:
    ...
    Useful if you want to add support for a csp extension in a subclass.
    """
    return property(
...
class ContentSecurityPolicy(CallbackDict[str, str]):
    """
    Subclass of a dict that stores values for a Content Security Policy header. It has
    accessors for all the level 3 policies.
