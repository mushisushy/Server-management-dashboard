...
class FileStorage:
    ...
    def mimetype(self) -> str:
        ...
        etc.) and always lowercase.  For example if the content type is ``text/HTML;
...
class FileMultiDict(MultiDict[str, FileStorage]):
    """
    A special :class:`MultiDict` that has convenience methods to add files to it.  This
    is used for :class:`EnvironBuilder` and generally useful for unittesting.
