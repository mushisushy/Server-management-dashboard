...
def secure_filename(filename: str) -> str:
    ...
    then safely be stored on a regular file system and passed to :func:`os.path.join`.
...
def redirect(
    ...
    to the target location. Supported codes are 301, 302, 303, 305, 307, and 308. 300 is
    not supported because it's not a real redirect and 304 because it's the answer for a
...
def find_modules(
    ...
    """
    Finds all the modules below a package.  This can be useful to automatically import
    all views / controllers so that their metaclasses / function decorators have a
    chance to register themselves on the application.
