...
class ValidationError(ValueError):
    ...
    If a rule converter raises this exception the rule does not match the current URL
...
class UnicodeConverter(BaseConverter):
    """
    This converter is the default converter and accepts any string but only one path
    segment.  Thus the string can not include a slash.
