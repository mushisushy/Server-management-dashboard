...
class ExtrasCandidate(Candidate):
    ...
    def _calculate_valid_requested_extras(self) -> FrozenSet[str]:
        ...
        The user (or upstream dependant) may have specified extras that the candidate
        doesn't support. Any unsupported extras are dropped, and each cause a warning to
        be logged here.
        """
