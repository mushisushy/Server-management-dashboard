...
class pyparsing_common:
    ...
    """Expression that parses a floating point number with optional scientific notation
    and returns a float."""
    ...
    """Typical code identifier (leading alpha or '_', followed by 0 or more alphas,
    nums, or '_')"""
    ...
    def convert_to_datetime(fmt: str = "%Y-%m-%dT%H:%M:%S.%f"):
        """
        Helper to create a parse action for converting parsed datetime string to Python
        datetime.datetime.
